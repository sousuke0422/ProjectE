...
/**
 * Defines the contract for arbitrary objects that can store EMC You usually do not want to use this directly Use
 * extensions IEMCAcceptor and IEMCProvider, or the provided reference implementations instead
 *
 * @author williewillus
 */
