...
/**
 * This interface is now DEPRECATED. Do not use! Update to IEMCAcceptor, IEMCProvider, or TileEmcHandler ASAP!! You will
 * not crash, but using this will have no effect as the ProjectE machines no longer recognize nor implement this
 * interface
 */
@Deprecated
public interface ITileEmc {
    ...
    /**
     * If this returns true, the Tile Entity will accept EMC from any valid provider EMC will be received only on the
     * server side
     * 
