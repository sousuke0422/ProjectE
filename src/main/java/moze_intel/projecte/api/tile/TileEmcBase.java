...
/**
 * Base class for the reference implementations TileEmcProvider, TileEmcAcceptor, and TileEmcHandler Usually you want to
 * use one of three derived reference implementations Extend this if you want fine-grained control over all aspects of
 * how your tile provides or accepts EMC
 *
 * @author williewillus
 */
