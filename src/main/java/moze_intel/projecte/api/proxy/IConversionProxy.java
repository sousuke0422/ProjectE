...
public interface IConversionProxy {
     ...
     * value of other items. ProjectE will automatically select the Conversion with the lowest EMC value.
     *
     ...
     *
     * Use the {@code amount} parameter to specify how many {@code output}s are created. Use the value in the
     * {@code ingredients}-Map to specify how much of an ingredient is required. (Use Millibuckets for Fluids)
     *
     * Examples:
     *
     * <pre>
