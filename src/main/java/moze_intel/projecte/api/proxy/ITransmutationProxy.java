...
public interface ITransmutationProxy {
    ...
    /**
     * Register a world transmutation with the Philosopher's Stone Calls this during the postinit phase
     * 
     ...
     * server is started If called on the client side, playerUUID is ignored and the client player is used instead
     * 
    ...
    /**
     * Queries all the knowledge of the provided player Can be called on both sides, only if the client player exists or
     * the server is started If called on the client side, playerUUID is ignored and the client player is used instead
     * 
     * @param playerUUID The Player to query
    ...
    /**
     * Adds to the knowledge of the provided player. Only works if player is online Calls may only be issued on the
     * server side, and if the server is running
     * 
    ...
    /**
     * Removes from the knowledge of the provided player. Only works if player is online Calls may only be issued on the
     * server side, and if the server is running
     * 
     * @param playerUUID The Player to modify
    ...
    /**
     * Sets the player's personal transmutation emc to that provided. Only works if player is online Calls may only be
     * issued on the server side, and if the server is running
     * 
     * @param playerUUID The Player to modify
    ...
    /**
     * Gets the player's personal transmutation emc Can be called on both sides, only if the client player exists or the
     * server is started If called on the client side, playerUUID is ignored and the client player is used instead
     * 
     * @param playerUUID The Player to modify
