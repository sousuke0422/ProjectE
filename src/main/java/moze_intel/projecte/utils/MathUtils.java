...
/**
 * Helper class for any method that turns numbers into other numbers. Named Utils to not clash with vanilla classes
...
public final class MathUtils {
    ...
    /**
     * Converts ticks to seconds, and adds the string unit on. If result is 0, then "every tick" is appended Take care
     * when calling this serverside, the units will be in the Locale of the server.
     */
